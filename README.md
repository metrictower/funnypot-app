...
box. It runs the HTTP deception engine across the common web ports and adds 30 network-service honeypots
...
the web ports and launches all 30 service listeners (each auto-respawned if it ever exits).
