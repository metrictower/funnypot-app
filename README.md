...
box. It runs the HTTP deception engine across the common web ports and adds 25 network-service honeypots
...
the web ports and launches all 25 service listeners (each auto-respawned if it ever exits).
